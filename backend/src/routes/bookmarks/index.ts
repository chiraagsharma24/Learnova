...
import { createBookmark, deleteBookmark, getBookmarks } from "./controller.js";
...
router.get(
	...
	asyncHandler(async (req: AuthRequest, res: Response) => {
		...
		if (!bookmarksFound)
			return failure(res, 404, "Error to fetch bookmarks");
...
router.post(
	...
	asyncHandler(async (req: AuthRequest, res: Response) => {
		...
		if (!bookmarkCreated)
			return failure(res, 404, "Error to create bookmark");
