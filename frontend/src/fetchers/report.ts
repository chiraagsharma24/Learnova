...
export const fetchAdminStats = () => api.get("/api/reports/admin/stats").then(extractData) as Promise<AdminStats>;

export const fetchAdminCoursePerformance = () =>
  api.get("/api/reports/admin/course-performance").then(extractData) as Promise<CoursePerformanceRow[]>;
