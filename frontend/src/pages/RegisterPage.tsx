                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative">
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className={`flex flex-col items-center gap-3 p-4 rounded-3xl border-2 transition-all ${formData.role === "learner"
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center gap-3 p-4 rounded-3xl border-2 transition-all ${formData.role === "instructor"
                                        ? "border-indigo-600 bg-indigo-50 text-indigo-900"
                                        : "border-slate-100 bg-white text-slate-500 hover:border-slate-200"
                                    }`}
                            >
                        ...
                        >
                            {loading ? "Creating Account..." : "Start Learning Free"} <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </button>
                    </form>
